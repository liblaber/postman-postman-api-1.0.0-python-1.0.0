...
class GetEnvironmentsOkResponseEnvironments(BaseModel):
...
@JsonMap({})
class GetEnvironmentsOkResponse(BaseModel):
    """GetEnvironmentsOkResponse

    :param environments: environments, defaults to None
    :type environments: List[GetEnvironmentsOkResponseEnvironments], optional
    """

    def __init__(
        self, environments: List[GetEnvironmentsOkResponseEnvironments] = None
    ):
        if environments is not None:
            self.environments = self._define_list(
                environments, GetEnvironmentsOkResponseEnvironments
            )
