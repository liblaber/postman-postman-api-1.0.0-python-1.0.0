...
@JsonMap({"id_": "id"})
class DeleteCollectionRequestOkResponseData(BaseModel):
...
@JsonMap({})
class DeleteCollectionRequestOkResponse(BaseModel):
    ...
    :type data: DeleteCollectionRequestOkResponseData, optional
    ...
    def __init__(
        ...
        model_id: str = None,
        meta: dict = None,
        data: DeleteCollectionRequestOkResponseData = None,
        revision: float = None,
    ):
        ...
        if meta is not None:
            self.meta = meta
        if data is not None:
            self.data = self._define_object(data, DeleteCollectionRequestOkResponseData)
