...
@JsonMap({})
class GetApiSchemaOkResponse1Files(BaseModel):
...
class GetApiSchemaOkResponse1(BaseModel):
    ...
    :type files: GetApiSchemaOkResponse1Files, optional
    ...
    def __init__(
        ...
        id_: str = None,
        type_: str = None,
        files: GetApiSchemaOkResponse1Files = None,
        created_at: str = None,
        created_by: str = None,
        updated_at: str = None,
        updated_by: str = None,
        ...
        if files is not None:
            self.files = self._define_object(files, GetApiSchemaOkResponse1Files)
        if created_at is not None:
            self.created_at = created_at
        if created_by is not None:
            self.created_by = created_by
...
class GetApiSchemaOkResponse2(BaseModel):
    """Information about the schema.
...
class GetApiSchemaOkResponseGuard(OneOfBaseModel):
    class_list = {
        "GetApiSchemaOkResponse1": GetApiSchemaOkResponse1,
        "GetApiSchemaOkResponse2": GetApiSchemaOkResponse2,
    }


GetApiSchemaOkResponse = Union[GetApiSchemaOkResponse1, GetApiSchemaOkResponse2]
