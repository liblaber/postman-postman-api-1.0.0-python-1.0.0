...
class GetScimUserResourcesOkResponse(BaseModel):
    """GetScimUserResourcesOkResponse

    :param resources: A list of user resources., defaults to None
    :type resources: List[ScimUserResource], optional
    ...
    def __init__(
        self,
        resources: List[ScimUserResource] = None,
        ...
        if resources is not None:
            self.resources = self._define_list(resources, ScimUserResource)
