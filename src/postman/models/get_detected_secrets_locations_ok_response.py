...
class GetDetectedSecretsLocationsOkResponseData(BaseModel):
...
class GetDetectedSecretsLocationsOkResponseMeta(BaseModel):
...
@JsonMap({})
class GetDetectedSecretsLocationsOkResponse(BaseModel):
    """GetDetectedSecretsLocationsOkResponse

    :param data: data, defaults to None
    :type data: List[GetDetectedSecretsLocationsOkResponseData], optional
    :param meta: meta, defaults to None
    :type meta: GetDetectedSecretsLocationsOkResponseMeta, optional
    """

    def __init__(
        self,
        data: List[GetDetectedSecretsLocationsOkResponseData] = None,
        meta: GetDetectedSecretsLocationsOkResponseMeta = None,
    ):
        if data is not None:
            self.data = self._define_list(
                data, GetDetectedSecretsLocationsOkResponseData
            )
        if meta is not None:
