...
@JsonMap({"id_": "id"})
class UpdateMonitorOkResponseMonitor(BaseModel):
...
class UpdateMonitorOkResponse(BaseModel):
    ...
    :type monitor: UpdateMonitorOkResponseMonitor, optional
    """

    def __init__(self, monitor: UpdateMonitorOkResponseMonitor = None):
        if monitor is not None:
            self.monitor = self._define_object(monitor, UpdateMonitorOkResponseMonitor)
