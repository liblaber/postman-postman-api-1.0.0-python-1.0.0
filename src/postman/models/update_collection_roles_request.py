...
@JsonMap({})
class UpdateCollectionRolesRequestRoles(BaseModel):
...
class UpdateCollectionRolesRequest(BaseModel):
    ...
    :param roles: roles
    :type roles: List[UpdateCollectionRolesRequestRoles]
    """

    def __init__(self, roles: List[UpdateCollectionRolesRequestRoles]):
        self.roles = self._define_list(roles, UpdateCollectionRolesRequestRoles)
