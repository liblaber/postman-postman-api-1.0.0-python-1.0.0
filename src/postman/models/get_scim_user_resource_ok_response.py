...
class GetScimUserResourceOkResponseName(BaseModel):
...
class GetScimUserResourceOkResponseMeta(BaseModel):
...
class GetScimUserResourceOkResponse(BaseModel):
    ...
    :type name: GetScimUserResourceOkResponseName, optional
    ...
    :type meta: GetScimUserResourceOkResponseMeta, optional
    """
    ...
    def __init__(
        ...
        id_: str = None,
        user_name: str = None,
        name: GetScimUserResourceOkResponseName = None,
        external_id: str = None,
        active: bool = None,
        meta: GetScimUserResourceOkResponseMeta = None,
    ):
        ...
        if name is not None:
            self.name = self._define_object(name, GetScimUserResourceOkResponseName)
        if external_id is not None:
            self.external_id = external_id
        if active is not None:
            self.active = active
        if meta is not None:
            self.meta = self._define_object(meta, GetScimUserResourceOkResponseMeta)
