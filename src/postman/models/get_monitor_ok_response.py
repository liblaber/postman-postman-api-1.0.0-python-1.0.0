...
class GetMonitorOkResponseMonitor(BaseModel):
...
@JsonMap({})
class GetMonitorOkResponse(BaseModel):
    """GetMonitorOkResponse

    :param monitor: monitor, defaults to None
    :type monitor: GetMonitorOkResponseMonitor, optional
    """

    def __init__(self, monitor: GetMonitorOkResponseMonitor = None):
        if monitor is not None:
            self.monitor = self._define_object(monitor, GetMonitorOkResponseMonitor)
