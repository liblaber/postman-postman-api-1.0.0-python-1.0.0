...
class UpdateWorkspaceRolesOkResponseRoles(BaseModel):
...
class UpdateWorkspaceRolesOkResponse(BaseModel):
    ...
    :type roles: List[UpdateWorkspaceRolesOkResponseRoles], optional
    """

    def __init__(self, roles: List[UpdateWorkspaceRolesOkResponseRoles] = None):
        if roles is not None:
            self.roles = self._define_list(roles, UpdateWorkspaceRolesOkResponseRoles)
