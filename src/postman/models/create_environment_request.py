...
@JsonMap({})
class CreateEnvironmentRequestEnvironment(BaseModel):
...
class CreateEnvironmentRequest(BaseModel):
    ...
    :type environment: CreateEnvironmentRequestEnvironment, optional
    """

    def __init__(self, environment: CreateEnvironmentRequestEnvironment = None):
