...
class GetAllPanAddElementRequestsOkResponseRequests(BaseModel):
...
class GetAllPanAddElementRequestsOkResponseMeta(BaseModel):
...
@JsonMap({})
class GetAllPanAddElementRequestsOkResponse(BaseModel):
    ...
    :type requests: List[GetAllPanAddElementRequestsOkResponseRequests], optional
    :param meta: The response's non-standard meta information., defaults to None
    :type meta: GetAllPanAddElementRequestsOkResponseMeta, optional
    """

    def __init__(
        self,
        requests: List[GetAllPanAddElementRequestsOkResponseRequests] = None,
        meta: GetAllPanAddElementRequestsOkResponseMeta = None,
    ):
        if requests is not None:
            self.requests = self._define_list(
                requests, GetAllPanAddElementRequestsOkResponseRequests
            )
        if meta is not None:
            self.meta = self._define_object(
                meta, GetAllPanAddElementRequestsOkResponseMeta
            )
