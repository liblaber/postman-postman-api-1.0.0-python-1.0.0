...
class CollectionFoldersService(BaseService):

    @cast_models
    def get_folder_comments(
        self, collection_id: str, folder_id: str
    ) -> CommentResponse:
        """Gets all comments left by users in a folder.

        :param collection_id: The collection's unique ID.
        :type collection_id: str
        :param folder_id: The folder's unique ID.
        :type folder_id: str
        ...
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/{{collectionId}}/folders/{{folderId}}/comments",
    ...
    @cast_models
    def create_folder_comment(
        self, request_body: CommentCreateUpdate, collection_id: str, folder_id: str
    ...
    def update_folder_comment(
        ...
        **Note:**
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/{{collectionId}}/folders/{{folderId}}/comments/{{commentId}}",
                self.get_default_headers(),
            )
            .add_path("collectionId", collection_id)
            .add_path("folderId", folder_id)
    ...
    @cast_models
    def delete_folder_comment(
        self, collection_id: str, folder_id: str, comment_id: int
    ):
