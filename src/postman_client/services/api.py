...
class ApiService(BaseService):
    ...
    @cast_models
    def delete_api(self, api_id: str, accept: Accept) -> Any:
        """Deletes an API.
    ...
    @cast_models
    def delete_api_comment(self, api_id: str, comment_id: int) -> Any:
    ...
    @cast_models
    def delete_api_version(self, api_id: str, version_id: str, accept: Accept) -> Any:
