...
class CollectionRequestsService(BaseService):
    ...
    def get_request_comments(
        ...
        :param request_id: The request's unique ID.
        :type request_id: str
        ...
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/{{collectionId}}/requests/{{requestId}}/comments",
    ...
    def create_request_comment(
        self, request_body: CommentCreateUpdate, collection_id: str, request_id: str
    ...
    def update_request_comment(
        ...
        **Note:**
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/collections/{{collectionId}}/requests/{{requestId}}/comments/{{commentId}}",
                self.get_default_headers(),
            )
            .add_path("collectionId", collection_id)
            .add_path("requestId", request_id)
    ...
    def delete_request_comment(
        self, collection_id: str, request_id: str, comment_id: int
    ) -> Any:
