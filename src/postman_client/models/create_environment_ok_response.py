...
@JsonMap({"id_": "id"})
class CreateEnvironmentEnvironment2(BaseModel):
...
class CreateEnvironmentOkResponse(BaseModel):
    ...
    :type environment: CreateEnvironmentEnvironment2, optional
    """

    def __init__(self, environment: CreateEnvironmentEnvironment2 = None):
        """CreateEnvironmentOkResponse
