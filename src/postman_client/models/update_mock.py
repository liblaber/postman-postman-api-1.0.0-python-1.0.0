...
class MockConfig2(BaseModel):
    ...
    :param server_response_id: The server response ID. This sets the given server response as the default response for each request. To deactivate a server response, pass a null value. , defaults to None
    ...
    def __init__(self, server_response_id: str = None):
        ...
        if server_response_id is not None:
            self.server_response_id = self._define_str(
                "server_response_id", server_response_id, nullable=True
            )
