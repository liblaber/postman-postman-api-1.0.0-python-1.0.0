...
@JsonMap({"id_": "id"})
class CreateMonitorMonitor2(BaseModel):
...
class CreateMonitorOkResponse(BaseModel):
    ...
    :type monitor: CreateMonitorMonitor2, optional
    """

    def __init__(self, monitor: CreateMonitorMonitor2 = None):
        """CreateMonitorOkResponse
        ...
        if monitor is not None:
            self.monitor = self._define_object(monitor, CreateMonitorMonitor2)
