...
@JsonMap({"id_": "id"})
class CreateCollectionCollection2(BaseModel):
...
class CreateCollectionOkResponse(BaseModel):
    ...
    :type collection: CreateCollectionCollection2, optional
    """

    def __init__(self, collection: CreateCollectionCollection2 = None):
        """CreateCollectionOkResponse
