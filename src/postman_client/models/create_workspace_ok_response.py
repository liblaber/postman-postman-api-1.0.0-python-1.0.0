...
@JsonMap({"id_": "id"})
class CreateWorkspaceWorkspace2(BaseModel):
...
class CreateWorkspaceOkResponse(BaseModel):
    ...
    :type workspace: CreateWorkspaceWorkspace2, optional
    """

    def __init__(self, workspace: CreateWorkspaceWorkspace2 = None):
        """CreateWorkspaceOkResponse
        ...
        if workspace is not None:
            self.workspace = self._define_object(workspace, CreateWorkspaceWorkspace2)
