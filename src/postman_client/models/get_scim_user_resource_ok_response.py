...
class ScimUserResourceName2(BaseModel):
...
class ScimUserResourceMeta2(BaseModel):
...
class GetScimUserResourceOkResponse(BaseModel):
    ...
    def __init__(
        ...
        id_: str = None,
        user_name: str = None,
        name: ScimUserResourceName2 = None,
        ...
        if name is not None:
            self.name = self._define_object(name, ScimUserResourceName2)
        if external_id is not None:
            self.external_id = external_id
        if active is not None:
            self.active = active
        if meta is not None:
            self.meta = self._define_object(meta, ScimUserResourceMeta2)
