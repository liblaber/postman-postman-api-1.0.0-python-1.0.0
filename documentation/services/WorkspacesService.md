...
from postman_restapi.models import GetWorkspacesType, GetWorkspacesInclude
...
```python
from postman_restapi import PostmanRestapi, Environment
from postman_restapi.models import CreateWorkspaceRequest
...
```python
from postman_restapi import PostmanRestapi, Environment
from postman_restapi.models import UpdateWorkspaceRequest
...
```python
from postman_restapi import PostmanRestapi, Environment
from postman_restapi.models import UpdateWorkspaceGlobalVariablesRequest
...
```python
from postman_restapi import PostmanRestapi, Environment
from postman_restapi.models import UpdateWorkspaceRolesRequest
